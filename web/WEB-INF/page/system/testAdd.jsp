...
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  <script language="javascript"> 
   function checkchar(){
  		document.Form1.action="${pageContext.request.contextPath }/test/elecTestSave.do";
...
<form name="Form1" id="Form1" method=post>
	...
	<table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<textarea name="testName" id="textName"   style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('textName');"></textarea>
			</td>
		...
		<tr>
			...
			<input name="testDate" type="text" maxlength="50" size=20 onclick="WdatePicker()">
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
			<textarea name="testRemark" id="textRemark"  style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('textRemark');"></textarea>
			</td>
